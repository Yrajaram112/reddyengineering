            ...
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
              <div className="mb-12 max-w-[360px] lg:mb-16">
                ...
                <p className="dark:text-body-color-dark mb-9 text-base leading-relaxed text-body-color">
                  Unlock Your Dream University with 1:1 IITian Mentorship
                </p>
                <div className="flex items-center">
                  <Link
                    href="https://www.facebook.com/dreambigeducationconsultancy?mibextid=wwXIfr&mibextid=wwXIfr"
                  ...
                  <Link
                    href="https://www.instagram.com/dreambig_education_consultancy?igsh=MWV2NmhsYmQweHRiaw=="
                    aria-label="social-link"
                    className="dark:text-body-color-dark mr-6 text-body-color duration-300 hover:text-primary dark:hover:text-primary"
                  >
                    <svg
